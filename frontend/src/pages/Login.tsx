  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    try {
      ...
      const payload = identifier.includes('@')
        ...
        : { phone: identifier.trim(), password: data.password };
    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="surface-elevated p-8 sm:p-9">
          ...
          {errorMessage && (
            <div className="mb-5 p-3.5 bg-red-950/60 border border-red-500/40 text-red-200 rounded-xl text-sm flex items-start gap-2.5 animate-fade-in">
              <AlertCircle className="w-5 h-5 flex-shrink-0 text-red-400 mt-0.5" />
              <div className="flex-1">
                <p className="font-semibold text-red-300 text-xs uppercase tracking-wider">Authentication Error</p>
